...
const PupringFilter = (props) => {
  ...
  const formattedDate = (localDate) => {
    const changeFormate = new Date(localDate);
      ...
      <Box component="form">
        <Box component="div" className="top-bar">
          <Box component="div">
            ...
            <CustomDatePicker date={date?.first_date} name="first_date" setDate={setDate}/>
            <CustomDatePicker date={date?.last_date} name="last_date" setDate={setDate}/>
            <Modal
              open={openModal}
              onClose={handleModal}
